...
<div class="container" style="margin-left: 20px">  
    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalSignUp" id="signup" style="margin: 10px">Entry admin</button>
    <!-- Modal Sign Up -->
    ...
    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEdit1" id="edit" style="margin: 10px">Edit admin</button>
    <!-- Modal Edit -->
          ...
          <div class="modal-content">
              ...
              <div class="modal-body" style="margin: 0%;">
                <div class="container-fluid">
                  <div class="row d-flex justify-content-center align-items-center m-0">
                    <div class="login_oueter">
                      <form action="" method="post" id="editAdmin" autocomplete="off" class="bg-light border p-3">
                        <div class="form-row">
                          <div class="col-12">
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                              ...
                              <input name="namaadmin1" type="text" value="" class="input form-control" id="namaadmin1" placeholder="Masukkan nama admin" aria-label="namaadmin" aria-describedby="basic-addon1" style="height: 4vh;" required>
                            </div>
                          </div>
                          <div class="col-12">
                            <button class="btn btn-primary" type="button" name="getNama" style="width: 100%;" data-bs-toggle="modal" onclick="cekNama()" data-bs-target="#modalEdit2">OK</button>
                          </div>
                        </div>
                      </form>
                    </div>
                        ...
                        <div class="form-row">
                          <div class="col-12">
                            <div class="input-group mb-3">
                              ...
                              <input name="nama1" type="text" value="" class="input form-control" id="nama1" placeholder="Nama Admin" aria-label="nama" aria-describedby="basic-addon1" style="height: 4vh;" required>
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="input-group mb-3">
                              ...
                              <input name="username1" type="text" value="" class="input form-control" id="username1" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" style="height: 4vh;" required>
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="input-group mb-3">
                              ...
                              <input name="password1" type="password" value="" class="input form-control" id="password1" placeholder="Password" required="true" aria-label="password" aria-describedby="basic-addon1" style="height: 4vh;">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="input-group mb-3">
                              ...
                              <input name="confirm-password1" type="password" value="" class="input form-control" id="confirm-password1" placeholder="Confirm Password" required="true" aria-label="password" aria-describedby="basic-addon1" style="height: 4vh;">
                            </div>
                          </div>
                          <div class="col-12">
    ...
    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalnonaktif" id="signup" style="margin: 10px">Nonaktifkan admin</button>
...
<script>
    function cekNama() {
      <?php
        if (isset($_POST["namaadmin1"])) {
          $namaadmin = $_POST["namaadmin1"];
          require_once("connection.php");
          $sql = "SELECT * FROM detail_log_pengiriman WHERE nama_admin = '$namaadmin' AND status_aktif = 1";
          $result = $con->query($sql);
          if ($result->num_rows > 0) {
            ?>
            ...
            ?>
            alert("Name does not exist or non-active. Please choose a different name.");
            <?php
          }       
        }     
      ?>
...
<?php include "connection.php";
  ...
  if (isset($_POST["edit"])){
    ...
    $confirm = $_POST["confirm-password1"];
    if($password !== $confirm) {
      echo "<script>
            Swal.fire(
              'Error',
