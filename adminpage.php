...
<?php
    if(isset($_POST['delete1'])) {
        require("connection.php");
        $stmt = $con->prepare("DELETE FROM detail_log_pengiriman WHERE id = ?");
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    <?php
                                        require_once("connection.php");
                                        $sql = "SELECT * FROM detail_log_pengiriman";
                                        $result = $con->query($sql);
                                        if ($result->num_rows > 0) {
                                        // output data of each row
                                        $no = 1;
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <!-- bisa hapus tapi harus di refresh dulu biar hilang di tabel -->
                                                        <button class='btn btn-danger' name='delete1' value='<?php echo $row['id']; ?>' >Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
